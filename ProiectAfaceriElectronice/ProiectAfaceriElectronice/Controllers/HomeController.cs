...
namespace Imbracaminte.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IWebHostEnvironment hostEnvironment, ImbracaminteContext context, IHttpContextAccessor httpContextAccessor, IConfiguration configuration)
        {
